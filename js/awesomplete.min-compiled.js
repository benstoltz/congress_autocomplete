...
(function () {
  function m(a, b) {
    ...
    var c = this;this.input = d(a);this.input.setAttribute("autocomplete", "false");this.input.setAttribute("aria-autocomplete", "list");b = b || {};m.call(this, { minChars: 2, maxItems: 10, autoFirst: !1, filter: f.FILTER_CONTAINS, sort: f.SORT_BYLENGTH, item: function item(a, b) {
      ...
      } });d.bind(this.input.form, { submit: this.close.bind(this) });d.bind(this.ul, { mousedown: function mousedown(a) {
